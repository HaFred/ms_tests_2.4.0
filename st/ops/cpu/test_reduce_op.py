...
class NetReduce(nn.Cell):
    ...
    def construct(self, indice):
        return (self.reduce_mean(indice, self.axis0),
                ...
                self.reduce_max(indice, self.axis4),
...
def test_reduce():
    ...
    expect_3 = np.array([1.75]).astype(np.float32)
    expect_4 = np.array([[6., 3., 6., 9., 0., 3.], [6., 6., 3., 6., 9., 6.]]).astype(np.float32)
    expect_5 = np.array([[9., 12.], [9., 12.], [9., 12.]]).astype(np.float32)
    expect_6 = np.array([[4., 2., 4., 5., 0., 2.], [3., 5., 2., 4., 4., 3.]]).astype(np.float32)
    expect_7 = np.array([[4., 4.], [5., 4.], [4., 5.]]).astype(np.float32)
    expect_8 = np.array([[0., 0., 1., 0., 0., 0.], [1., 0., 0., 0., 1., 0.]]).astype(np.float32)
    expect_9 = np.array([[0., 1., 1., 2., 0., 0.], [1., 0., 0., 4., 0., 1.], [2., 1., 1., 0., 0., 0.]]).astype(
        np.float32)
    expect_10 = np.array([[0., 0.], [0., 0.], [0., 0.]]).astype(np.float32)
    ...
    assert (output[8].asnumpy() == expect_7).all()
    assert (output[9].asnumpy() == 5.0).all()
    assert (output[10].asnumpy() == expect_8).all()
    assert (output[11].asnumpy() == expect_9).all()
    assert (output[12].asnumpy() == expect_10).all()
    assert (output[13].asnumpy() == 0.0).all()
    assert (output[14].asnumpy() == expect_10).all()
